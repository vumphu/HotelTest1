...
def guest_add(guest_list, guest_tree, entry_frame, id_entry, name_entry, gend_entry, dob_entry, phone_entry, email_entry, address_entry):
    Label(entry_frame, bg='#5E95FF', fg='crimson', text='                                  ', font=("Times New Roman", 14, 'bold')).grid(column=6,row=0,sticky='w')
    Label(entry_frame, bg='#5E95FF', fg='crimson', text='                   ', font=("Times New Roman", 14, 'bold')).grid(column=6,row=1,sticky='w')
    Label(entry_frame, bg='#5E95FF', fg='crimson', text='                   ', font=("Times New Roman", 14, 'bold')).grid(column=6,row=2,sticky='w')
    Label(entry_frame, bg='#5E95FF', fg='crimson', text='                   ', font=("Times New Roman", 14, 'bold')).grid(column=6,row=3,sticky='w')
    ...
    if valid_check == 0:
        # Add to guest_list
        new_guest = Guest(id, name, gend, dob, phone, address, email)
        guest_list.append(new_guest)

        # Display on Treeview
        guest_tree.insert(parent='', index = 'end', iid=id, text='', values=(id, name, gend, dob, phone))
...
def guest_select(guest_list, guest_tree, entry_frame, id_entry, name_entry, gend_entry, dob_entry, phone_entry, email_entry, address_entry):
    # Delete all Warnings
    Label(entry_frame, bg='#5E95FF', fg='crimson', text='                                  ', font=("Times New Roman", 14, 'bold')).grid(column=6,row=0,sticky='w')
    Label(entry_frame, bg='#5E95FF', fg='crimson', text='                   ', font=("Times New Roman", 14, 'bold')).grid(column=6,row=1,sticky='w')
    Label(entry_frame, bg='#5E95FF', fg='crimson', text='                   ', font=("Times New Roman", 14, 'bold')).grid(column=6,row=2,sticky='w')
...
def guest_update(guest_list, guest_tree, entry_frame, id_entry, name_entry, gend_entry, dob_entry, phone_entry, email_entry, address_entry):
    global selected_guest
    if selected_guest != -1:
        Label(entry_frame, bg='#5E95FF', fg='crimson', text='                                  ', font=("Times New Roman", 14, 'bold')).grid(column=6,row=0,sticky='w')
        Label(entry_frame, bg='#5E95FF', fg='crimson', text='                   ', font=("Times New Roman", 14, 'bold')).grid(column=6,row=1,sticky='w')
...
def guest_press(window, width, height, guest_list):
    ...
    # Insert Data
    for guest in guest_list:
        guest_tree.insert(parent='', index = 'end', iid=guest.get_id(), text='', values=(guest.get_id(), guest.get_name(), guest.get_gend(), guest.get_dob(), guest.get_phone()))
    ...
    add_guest_button = Button(guest_subwin, text='ADD GUEST',anchor='center',font=("Times New Roman", 12,'bold'), fg='#5E95FF', relief='ridge',
        activebackground='dark blue', activeforeground='white', command=lambda: guest_add(guest_list, guest_tree, entry_frame, id_entry, name_entry, gend_entry, dob_entry, phone_entry, email_entry, address_entry))
    ...
    update_guest_button = Button(guest_subwin, text='UPDATE',anchor='center',font=("Times New Roman", 12,'bold'), fg='#5E95FF', relief='ridge',
        activebackground='dark blue', activeforeground='white', command=lambda: guest_update(guest_list, guest_tree, entry_frame, id_entry, name_entry, gend_entry, dob_entry, phone_entry, email_entry, address_entry))
    ...
    select_guest_button = Button(guest_subwin, text='SELECT',anchor='center',font=("Times New Roman", 12,'bold'), bg='#5E95FF',fg='white', relief='ridge',
        activebackground='dark blue', activeforeground='white', command=lambda: guest_select(guest_list, guest_tree, entry_frame, id_entry, name_entry, gend_entry, dob_entry, phone_entry, email_entry, address_entry))
